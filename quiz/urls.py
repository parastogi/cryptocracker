...
urlpatterns = [
        ...
        url(r'^(?P<hello>[0-9]+)/live/leaderboard/$',views.live_leaderboard,name='live_leaderboard'),
        url(r'^(?P<hello>[0-9]+)/live/get_leaderboard$',views.get_live_leaderboard,name='live_leaderboard'),
        url(r'^past/(?P<hello>[0-9]+)/leaderboard/$',views.leaderboard,name='leaderboard'),
